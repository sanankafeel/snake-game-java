...
public class SnakeGame extends JPanel implements ActionListener, KeyListener {
    ...
    public void move() {
        ...
        if (snakeHead.x*tileSize <= 0 || snakeHead.y*tileSize >= boardWidth || //passed left border or right border
            snakeHead.y*tileSize <= 0 || snakeHead.x*tileSize >= boardHeight ) { //passed top border or bottom border
            gameOver = true;
        }
    }
